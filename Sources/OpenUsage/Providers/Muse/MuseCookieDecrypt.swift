...
/// Safe Storage password. The crypto itself is `ClaudeDesktopAuthStore`'s proven pair
...
enum MuseBinaryCookies {
    ...
    static func allCookies(_ data: Data) -> [(url: String, name: String, value: String)] {
        ...
        for index in 0..<pageCount {
            let pageSize = Int(data[u32BE: 8 + 4 * index])
            ...
            let cookieCount = Int(page[u32LE: page.startIndex + 8])
            ...
            for slot in 0..<cookieCount {
                ...
                let recordOffset = page.startIndex + Int(page[u32LE: entry])
    ...
    private static func parseRecord(_ page: Data, at base: Data.Index) -> (String, String, String)? {
        ...
        let urlOffset = base + Int(page[u32LE: base + 16])
        let nameOffset = base + Int(page[u32LE: base + 20])
        let valueOffset = base + Int(page[u32LE: base + 28])
...
private extension Data {
    ...
    subscript(u32BE offset: Index) -> UInt32 {
    ...
    subscript(u32LE offset: Index) -> UInt32 {
